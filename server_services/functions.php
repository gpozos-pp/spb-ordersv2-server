...
function create_order( $access_token, $c_transactions ) {

  global $host;

  $postdata = get_json_order( $c_transactions );
...
function capture_order($access_token, $orderID) {

  global $host;
  $url = $host.'/v2/checkout/orders/'.$orderID.'/capture';
...
function get_json_order($c_transactions) {
