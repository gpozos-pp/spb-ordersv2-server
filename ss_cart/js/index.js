					...
					var item = '<div class="col-sm-6 col-md-4">' +
			                        '<div class="thumbnail">' +
			                          ...
			                          '<div class="caption">' +
			                            ...
			                            '<button class="btn btn-primary btn-lg btn-block" itemId="' + object.id + '" title="' + object.get("title") + '" imageUrl="' + object.get("image").url() + '" price="' + object.get("price") + '">Add to cart</button>'+
			                          '</div>' +
			                        '</div>' +
		                      	'</div>';		
